...
(function (GHCIDebug_1) {
    class GHCIDebug {
        ...
        run(commandText, emitStatusChanges, emitHistoryLength, emitCommand) {
                ...
                var command = {
                    ...
                    onFinish: (output) => {
                        ...
                        if (lastEndOfLine == -1) {
                            ...
                            if (emitStatusChanges) {
                                this.emitStatusChanges(output.slice(promptBeginPosition, output.length), output.slice(0, lastEndOfLine), emitHistoryLength).then(() => {
